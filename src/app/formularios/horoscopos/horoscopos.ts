export class HoroscopoChino {
  ...
  signos: { nombre: string, imagen: string }[] = [
    ...
    { nombre: 'Dragón', imagen: 'https://i.pinimg.com/736x/69/69/89/696989902cafe4269ba971ef198efc28.jpg' },
    { nombre: 'Serpiente', imagen: 'https://i.pinimg.com/736x/2d/d8/2b/2dd82bcb9de84d5aa6e15847586ded14.jpg' },
